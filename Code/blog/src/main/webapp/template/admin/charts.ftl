...
<html lang="en">
  ...
  <body>
	...
	<script src="${ctx}/assets/admin/js/flot/jquery.flot.js"></script>
	<script src="${ctx}/assets/admin/js/flot/jquery.flot.tooltip.min.js"></script>
	<script src="${ctx}/assets/admin/js/flot/jquery.flot.resize.js"></script>
	<script src="${ctx}/assets/admin/js/flot/jquery.flot.pie.js"></script>
	<script src="${ctx}/assets/admin/js/flot/chart-data-flot.js"></script>
